  ...
  try {
    ...
    if (
      ...
      return {
        ...
        data: response.data.data,
        message:
          response.data.message || "Leaderboard data retrieved successfully",
      };
    } else {
      return {
        status: response.status,
  ...
  try {
    ...
    if (
      ...
      return {
        ...
        data: response.data.data,
        message:
          response.data.message || "Announcements retrieved successfully!",
      };
    } else if (response.status === 401) {
      return {
        status: response.status,
...
export const GetTransactionsByTeacherAPI = async (
  url,
  token,
  teacherId,
  month
