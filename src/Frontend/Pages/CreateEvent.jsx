        ...
        <form onSubmit={handleSubmitEvent(onEventSubmit)} className="mb-[16px]">
          <div className="mb-4 relative w-full sm:w-96 md:w-[24rem] lg:w-[28rem] mx-auto">
            <input
              ...
              className={`w-full p-2 rounded bg-transparent border-2 border-black-200 text-black-300 focus:outline ${
                eventErrors.title ? "border-red-500" : ""
              }`}
          ...
          <div className="mb-4 relative w-full sm:w-96 md:w-[24rem] lg:w-[28rem] mx-auto">
            <textarea
              ...
              className={`w-full h-32 p-2 border-2 rounded bg-transparent border-black-200 text-black-300 focus:outline resize-none ${
                eventErrors.content ? "border-red-500" : ""
              }`}
          ...
          <div className="mb-4 relative w-full sm:w-96 md:w-[24rem] lg:w-[28rem] mx-auto">
            <input
              type="date"
              placeholder="Date"
              className={`w-full p-2 border-2 rounded bg-transparent border-black-200 [color-scheme:light] text-black-300 focus:outline [&::-webkit-calendar-picker-indicator]:text-black [&::-webkit-calendar-picker-indicator]:filter-none ${
                eventErrors.eventDate ? "border-red-500" : ""
              }`}
          ...
          <div className="mb-4 relative w-full sm:w-96 md:w-[24rem] lg:w-[28rem] mx-auto">
            <input
              ...
              className={`w-full p-2 border-2 rounded bg-transparent border-black-200 text-black-300 focus:outline ${
                eventErrors.venue ? "border-red-500" : ""
              }`}
          ...
          <div className="mb-4 relative w-full sm:w-96 md:w-[24rem] lg:w-[28rem] mx-auto">
            <input
              ...
              placeholder="Amount"
              className={`w-full p-2 border-2 rounded bg-transparent border-black-200 text-black-300 focus:outline ${
                eventErrors.amount ? "border-red-500" : ""
              }`}
              {...registerEvent("amount", { required: "Amount is required" })}
            />
            {eventErrors.amount && (
              <p className="text-danger text-sm mt-1">
                {eventErrors.amount.message}
              </p>
            )}
          </div>
