    ...
    <>
      <div className="min-h-full max-w-3xl flex items-center justify-center p-6">
        <div className="h-full w-full space-y-12 bg-white lg:pt-6 pt-8">
          <h2 className="h2 mb-[32px] text-left text-black-300">
            Create Announcement
          </h2>

          {/* Announcement Form with React Hook Form */}
          <form
            onSubmit={handleSubmitAnnouncement(onAnnouncementSubmit)}
          ...
          >
            <div className="mb-4 relative w-full sm:w-96 md:w-[24rem] lg:w-[28rem] mx-auto">
              <input
                ...
                className={`w-full p-2 border-2 rounded bg-transparent border-black-100 focus:outline focus:outline-2 focus:outline-black-200 text-black-300 ${
                  announcementErrors.title ? "border-red-500" : ""
                }`}
            ...
            <div className="mb-4 relative w-full sm:w-96 md:w-[24rem] lg:w-[28rem] mx-auto">
              <textarea
                ...
                className={`w-full h-32 p-2 border-2 rounded bg-transparent border-black-100 focus:outline focus:outline-2 focus:outline-black-200 text-black-300 resize-none ${
                  announcementErrors.description ? "border-red-500" : ""
                }`}
