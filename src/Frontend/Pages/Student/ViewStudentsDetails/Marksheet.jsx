...
const StudentMarksheet = ({ studentData, examData, results }) => {
  ...
  const calculateResults = () => {
    if (!results || results.length === 0)
      return { totalObtained: 0, totalMax: 0, percentage: 0 };
  ...
  const getPerformanceMessage = (percentage) => {
    ...
    if (percentage >= 80)
      return "Excellent performance! You have shown great understanding.";
    if (percentage >= 70)
      return "Very good performance! Continue working hard.";
    if (percentage >= 60)
      return "Good performance! With more effort, you can achieve higher.";
    if (percentage >= 50)
      return "Satisfactory performance. Focus on areas that need improvement.";
    if (percentage >= 40)
      return "Fair performance. You need to work harder to improve.";
    ...
    return (
      <div className="bg-white p-6 rounded-lg shadow-md">
        <p className="text-center text-black-100">
          No results available to generate marksheet.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md">
      <h2 className="text-xl font-bold text-black-300 mb-4">
        Student Marksheet
      </h2>
      ...
      >
        ...
        <div className="flex items-center bg-blue-100 p-4 rounded-t-lg">
          ...
          <div>
            ...
            <p className="text-black-300">Little Scholar Central School</p>
          </div>
        </div>
          ...
          <table className="min-w-full border border-gray-300">
            <thead>
              <tr className="bg-blue-500 text-white">
                ...
                <th className="py-2 px-4 text-center border-b border-gray-300">
                  Obtained Marks
                </th>
                <th className="py-2 px-4 text-center border-b border-gray-300">
                  Total Marks
        ...
        <div className="mt-4 text-center text-sm text-black-100">
          <p>
            This report card was generated by Little Scholar Central School on{" "}
